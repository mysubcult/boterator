...
PUBLIC_TEXTS = {
    "ru": {
        ...
        "author_reject_reason": "🚫 Причина: {reason}",
        "author_reject_note": "💬 Комментарий модератора:\n{note}",
        ...
        "vote_expired": "❌ К сожалению, сообщение не было одобрено для публикации.",
        "vote_expired_with_ai": "❌ К сожалению, сообщение не было одобрено для публикации.",
        ...
        "ai_analysis_checking_short": "Проверяю сообщение...",
        "ai_auto_title": "🚦 Авто после таймаута",
        "ai_analysis_failed": "AI-анализ временно недоступен.",
        "status_published": "✅ Статус: опубликовано.",
        "status_ai_auto_published": "✅ Статус: опубликовано ботом после таймера.",
        ...
        "voters_yes": "✅ За: {voters}",
        "voters_no": "❌ Против: {voters}",
        "rejected_by": "👤 Отклонил: {moderator}",
        "reject_reason_title": "🚫 Причина",
        "reject_reason_prompt": "🚫 Выберите причину отклонения:",
        "auto_filter_title": "🧱 Автофильтр",
        ...
        "reject_note_prompt": "✍️ Пришлите текст причины отклонения для автора. /cancel - отмена.",
        "reject_note_empty": "⚠️ Пришлите текст причины или /cancel.",
        "reject_note_too_long": "⚠️ Причина слишком длинная. Максимум {max} символов.",
        "reject_note_done": "✅ Сообщение отклонено с вашим текстом причины.",
    ...
    "en": {
        ...
        "author_reject_reason": "🚫 Reason: {reason}",
        "author_reject_note": "💬 Moderator note:\n{note}",
        ...
        "vote_expired": "❌ Unfortunately, your submission was not approved for publication.",
        "vote_expired_with_ai": "❌ Unfortunately, your submission was not approved for publication.",
        ...
        "ai_analysis_checking_short": "Checking the message...",
        "ai_auto_title": "🚦 Auto after timeout",
        "ai_analysis_failed": "AI analysis is temporarily unavailable.",
        "status_published": "✅ Status: published.",
        "status_ai_auto_published": "✅ Status: published by the bot after timeout.",
        ...
        "voters_yes": "✅ Yes: {voters}",
        "voters_no": "❌ No: {voters}",
        "rejected_by": "👤 Rejected by: {moderator}",
        "reject_reason_title": "🚫 Reason",
        "reject_reason_prompt": "🚫 Select rejection reason:",
        "auto_filter_title": "🧱 Auto filter",
        ...
        "reject_note_prompt": "✍️ Send the rejection reason text for the author. /cancel cancels.",
        "reject_note_empty": "⚠️ Send reason text or /cancel.",
        "reject_note_too_long": "⚠️ Reason is too long. Maximum is {max} characters.",
        "reject_note_done": "✅ Message rejected with your custom reason.",
